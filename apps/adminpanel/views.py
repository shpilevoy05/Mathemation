...
SECTIONS = [
    {"group": "Обучение", "items": [
        ...
        {"key": "assignments", "title": "Задачи",
         "columns": ["id", "title", "exam_part", "answer_type", "difficulty",
                     "max_score"]},
        {"key": "solution-paths", "title": "Пути решения",
         "columns": ["id", "code", "title", "assignment", "path_type", "is_active"]},
        {"key": "solution-steps", "title": "Шаги путей",
         "columns": ["id", "path", "order", "stage", "node", "role", "signal",
    ...
    {"group": "Граф и экзамен", "items": [
        ...
        {"key": "nodes", "title": "Узлы графа",
         "columns": ["id", "code", "title", "cluster", "node_type", "parent",
                     "layer", "exam_part", "hours_estimate"]},
        {"key": "dependencies", "title": "Зависимости",
         "columns": ["id", "node", "prerequisite", "kind", "min_mastery"]},
